...
urlpatterns = patterns('product.views',
    ...
    url(r'^(?P<product_id>\d+)/edit/$',         'product_edit',          name = 'product_edit'),
    url(r'^(?P<product_id>\d+)/send/$',         'product_send',  name = 'product_send'),
    url(r'^(?P<product_id>\d+)/edit/connect/$', 'linking',       name = 'product_linking'),
    url(r'^(?P<product_id>\d+)/photo/add/$',     'photo_add',     name = 'photo_add'),
    url(r'^(?P<product_id>\d+)/photo/(?P<photo_id>\d+)/edit/$',     'photo_edit',     name = 'photo_edit'),
)
