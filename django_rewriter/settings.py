# Django settings for django_rewriter project.
...
DATABASES = {
    'default': {
        ...
        'NAME': path.join(DIR_NAME, 'db.sqlite'), # Or path to database file if using sqlite3.
...
MEDIA_ROOT = path.join(DIR_NAME, 'media')
...
SECRET_KEY = '^5zz^_5j0$o$$i7@#@va)yy$ue7*r_zf9w&g486&80ofn42r0q'
